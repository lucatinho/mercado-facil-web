...
@Component({
  selector: 'app-info-pronto',
  templateUrl: './info-pronto.component.html',
  styleUrls: ['./info-pronto.component.css']
})
export class InfoProntoComponent implements OnInit {
  ...
  cancel(): void {
    this.router.navigate(['pedido/pronto']);
  }
